...
const EditTicket = () => {
    ...
    const getTickets = async () => {
        const t = await axios.get('http://192.168.1.175:4000/api/tickets/' + newid.id);
        setOneTicket(t.data);
    }
    ...
    const updateTickets = async () => {
        await axios.put('http://192.168.1.175:4000/api/tickets/' + newid.id, {
            waiter: name,
            table: table,
            qty: qty,
            products: products,
        ...
        window.location.href='http://192.168.1.175:3000/pos/tickets';
    }

    /*Delete Ticket | Boton eliminar en tickets*/
    const deleteTicket = async () => {
        await axios.delete('http://192.168.1.175:4000/api/tickets/' + newid.id);
        window.location.href='http://192.168.1.175:3000/pos/tickets';
    }
