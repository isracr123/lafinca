...
const KitchenEdit = () => {
    ...
    const getKitchen = async () => {
        const k = await axios.get('http://192.168.0.243:4000/api/kitchen/' + newid.id);
    ...
    const updateKitchen = async () => {
        await axios.put('http://192.168.0.243:4000/api/kitchen/'+ newid.id,{
            waiter: name,
            table: table,
            qty: qty,
            products: products          
    ...
    const updateWithoutAlerts = async () => {
        ...
        window.location.href = 'http://192.168.0.243:3000/editkitchen/' + newid.id ;
    }

    /*Create tickets*/
    const createTickets = async () => {
        await axios.post('http://192.168.0.243:4000/api/tickets', {
            waiter: name,
            table: table,
            qty: qty,
            products: products,
    ...
    const deleteOneKitchen = async () => {
        await axios.delete('http://192.168.0.243:4000/api/kitchen/' + newid.id);
    }
