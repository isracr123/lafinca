...
const WaiterThreeEdit = () => {
  ...
  const getOneWaiter = async (id) => {
    const w = await axios.get('http://192.168.0.243:4000/api/waiterThree/' + id);
  ...
  const updateOneWaiter = async () => {
    await axios.put('http://192.168.0.243:4000/api/waiterThree/' + id, {
        qty: qty || oldQty,
  ...
  const deleteWaiter = async () => {
    await axios.delete('http://192.168.0.243:4000/api/waiterThree/' + id);
    window.location.href='http://192.168.0.243:3000/waiterThree';
  }
