  ...
  render() {
    return (
      ...
      <div className='flex flex-row md:flex-col items-center px-4 md:py-4 md:flex-shrink-0 h-20 md:h-auto w-full md:w-20 bg-yellow-500 rounded-3xl'>
          <a className='flex items-center justify-center h-12 w-12 bg-cyan-50 text-yellow-700 rounded-2xl' href='http://192.168.0.3:3000/'>
          ...
          <ul className='flex flex-row md:flex-col space-x-2 md:space-x-0 md:space-y-2 ml-12 md:ml-0 md:mt-12'>
              <li>
                  <a className='flex items-center' href="http://192.168.0.3:3000/pos/">
              ...
              <li>
                  <a className='flex items-center' href="http://192.168.0.3:3000/pos/tickets">
