...
const Receipt = () => {
    ...
    const deleteTotal = async (id) => {
        await axios.delete('http://192.168.1.175:4000/api/total/' + id);
    }

    /*Delete All Cart*/
    const deleteAllCart = async () => {
        await axios.delete('http://192.168.1.175:4000/api/cart/');
    }
    ...
    const createTickets = (id) => {
        if (table === 0 || name === ''){
            ...
            axios.post('http://192.168.1.175:4000/api/tickets', {
                date: date,
                waiter: name,
                table: table,
                qty: qty,
            ...
            <div className='w-96 rounded-3xl bg-black shadow-xl overflow-hidden z-10 '>
                ...
                <div className='p-4 w-full'>
                    <div className='space-y-2'>
                        ...
                        const function1 = window.location.href='http://192.168.1.175:3000/pos/';
